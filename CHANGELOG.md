...
* **api:** api update ([1d1f55f](https://github.com/Svahnar/svahnar-python/commit/1d1f55f8cbaf216321787427c12a4a4fb7888cab))
* **api:** api update ([f6fe357](https://github.com/Svahnar/svahnar-python/commit/f6fe35762ea1e642cecd35e8a1d772185e6019a7))
* **api:** api update ([d7710e9](https://github.com/Svahnar/svahnar-python/commit/d7710e9907f95153a3af70d721157e74a54f79fe))
...
* **api:** api update ([8ccaf1f](https://github.com/Svahnar/svahnar-python/commit/8ccaf1f871932c397f02ad2adac922ff2d74add8))
* **api:** api update ([ef7f48b](https://github.com/Svahnar/svahnar-python/commit/ef7f48bbc6c90cba56aca5189db25bac19b55b55))
* **api:** api update ([af337be](https://github.com/Svahnar/svahnar-python/commit/af337bea2b8c4e9b53b525066cbf9127c429812b))
...
* **api:** api update ([214e0a5](https://github.com/Svahnar/svahnar-python/commit/214e0a524fd3f39ac5806593370b37e2d2163d4c))
...
* **internal:** implement indices array format for query and form serialization ([c230cdf](https://github.com/Svahnar/svahnar-python/commit/c230cdf85e2c9fa9835e73aa6cb143f1ee3e6aaa))
...
* **deps:** bump minimum typing-extensions version ([f132b6d](https://github.com/Svahnar/svahnar-python/commit/f132b6d77ce36f924719db7cdfa2b6385d1e91fb))
...
* **pydantic:** do not pass `by_alias` unless set ([8a4ff71](https://github.com/Svahnar/svahnar-python/commit/8a4ff71d5da486c5f09471f4ec7c5a403d27d9a1))
* sanitize endpoint path params ([7921d64](https://github.com/Svahnar/svahnar-python/commit/7921d64da54681e21028dc030d2a646b7dba62d6))
...
* **ci:** skip lint on metadata-only changes ([3afff06](https://github.com/Svahnar/svahnar-python/commit/3afff06d4854ff89019daf675cecf37c96783c98))
...
* **internal:** tweak CI branches ([76c664f](https://github.com/Svahnar/svahnar-python/commit/76c664ff15c468c7663928421b10d79e06271b5a))
...
* **internal:** update gitignore ([6f7f38b](https://github.com/Svahnar/svahnar-python/commit/6f7f38b8dc8034a420c6eaefc9ba27927a632f86))
...
Full Changelog: [v1.8.0...v1.9.0](https://github.com/Svahnar/svahnar-python/compare/v1.8.0...v1.9.0)
